...
//-----------------------------------------------------------------------------------------------------
var ModuleNamesBindings = {'STATE' : 'Модуль температур', 'HUMIDITY' : 'Модуль влажности', 'LIGHT' : 'Модуль освещенности', 'DELTA' : 'Модуль дельт', 'SOIL' : 'Модуль влажности почвы', 'PH' : 'Модуль контроля pH', '0' : 'Температура прибора'}
